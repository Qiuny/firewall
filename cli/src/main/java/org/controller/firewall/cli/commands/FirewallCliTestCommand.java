 ...
 */
package org.controller.firewall.cli.commands;
...
public class FirewallCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(FirewallCliTestCommand.class);
    protected final FirewallCliCommands service;

    public FirewallCliTestCommand(final FirewallCliCommands service) {
